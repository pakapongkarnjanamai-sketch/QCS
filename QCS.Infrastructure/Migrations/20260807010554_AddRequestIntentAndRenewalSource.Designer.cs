...
namespace QCS.Infrastructure.Migrations
{
    ...
    [Migration("20260807010554_AddRequestIntentAndRenewalSource")]
    partial class AddRequestIntentAndRenewalSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QCS.Domain.Models.Request", b =>
                {
                    ...
                    b.Property<int?>("RenewedFromRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RenewedFromRequestId")
            ...
            modelBuilder.Entity("QCS.Domain.Models.Quotation", b =>
                {
                    ...
                    b.HasOne("QCS.Domain.Models.Quotation", "SourceQuotation")
                        .WithMany()
            ...
            modelBuilder.Entity("QCS.Domain.Models.Request", b =>
                {
                    b.HasOne("QCS.Domain.Models.Request", "RenewedFromRequest")
                        .WithMany()
                        .HasForeignKey("RenewedFromRequestId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("RenewedFromRequest");
                });
