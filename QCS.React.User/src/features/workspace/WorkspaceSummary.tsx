...
export function WorkspaceSummary({ data, activeView, onViewChange }: WorkspaceSummaryProps) {
  return <section aria-label="Request summary" className="grid shrink-0 grid-cols-2 gap-px overflow-hidden rounded-sm border border-border-subtle bg-border-subtle lg:grid-cols-4">
