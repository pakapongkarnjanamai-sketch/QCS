import { ArrowDown, ArrowUp, ExternalLink, FileText, Trash2, Upload } from 'lucide-react'
...
interface TypedDocumentEditorProps {
  ...
  disabled: boolean
  error?: string
  onUpload: (files: File[], documentTypeId: number) => void
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border-subtle px-4 py-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <select
            ...
            className={appInputClassName('sm', 'w-auto max-w-full')}
          >
                  ...
                  <td className="px-3 py-2">
                    <div className="flex min-w-0 items-center gap-2">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-caption text-ink-muted">{formatFileSize(document.fileSize)}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-3 py-2">
